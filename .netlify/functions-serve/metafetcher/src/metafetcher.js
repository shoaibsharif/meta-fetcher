...
var require_unfetch = __commonJS((exports, module2) => {
...
var require_isomorphic_unfetch = __commonJS((exports, module2) => {
  function r(m) {
    return m && m.default || m;
  }
  module2.exports = global.fetch = global.fetch || (typeof process == "undefined" ? r(require_unfetch()) : function(url, opts) {
    return r(require_lib())(String(url).replace(/^\/\//g, "https://"), opts);
  });
});
...
var require_entities = __commonJS((exports, module2) => {
...
var require_legacy = __commonJS((exports, module2) => {
...
var require_FeedHandler = __commonJS((exports) => {
  ...
  function parseFeed(feed, options) {
    ...
    var handler2 = new FeedHandler(options);
...
var require_htmlparser2 = __commonJS((exports) => {
  "use strict";
  var __importDefault = exports && exports.__importDefault || function(mod) {
    return mod && mod.__esModule ? mod : {default: mod};
  };
...
var require_error_codes = __commonJS((exports, module2) => {
  "use strict";
  module2.exports = {
...
var require_preprocessor = __commonJS((exports, module2) => {
  "use strict";
...
var require_named_entity_data = __commonJS((exports, module2) => {
  "use strict";
...
var require_tokenizer = __commonJS((exports, module2) => {
  "use strict";
...
var require_open_element_stack = __commonJS((exports, module2) => {
  "use strict";
...
var require_formatting_element_list = __commonJS((exports, module2) => {
  "use strict";
...
var require_mixin = __commonJS((exports, module2) => {
  "use strict";
  var Mixin = class {
    constructor(host) {
...
var require_preprocessor_mixin = __commonJS((exports, module2) => {
  "use strict";
...
var require_tokenizer_mixin = __commonJS((exports, module2) => {
  "use strict";
  var Mixin = require_mixin();
...
var require_open_element_stack_mixin = __commonJS((exports, module2) => {
  "use strict";
  var Mixin = require_mixin();
...
var require_parser_mixin = __commonJS((exports, module2) => {
  "use strict";
  var Mixin = require_mixin();
  var Tokenizer = require_tokenizer();
...
var require_mixin_base = __commonJS((exports, module2) => {
  "use strict";
  var Mixin = require_mixin();
...
var require_preprocessor_mixin2 = __commonJS((exports, module2) => {
  "use strict";
...
var require_tokenizer_mixin2 = __commonJS((exports, module2) => {
  "use strict";
  var ErrorReportingMixinBase = require_mixin_base();
...
var require_parser_mixin2 = __commonJS((exports, module2) => {
  "use strict";
  var ErrorReportingMixinBase = require_mixin_base();
...
var require_merge_options = __commonJS((exports, module2) => {
  "use strict";
...
var require_serializer = __commonJS((exports, module2) => {
  "use strict";
  var defaultTreeAdapter = require_default();
  var mergeOptions = require_merge_options();
  var doctype = require_doctype();
...
var require_parse5 = __commonJS((exports) => {
  ...
  var domhandler_1 = require_lib3();
  var parse5_1 = require_lib8();
  var parse5_htmlparser2_tree_adapter_1 = tslib_1.__importDefault(require_lib9());
...
var require_parse = __commonJS((exports) => {
  ...
  var htmlparser2_1 = require_lib7();
  var htmlparser2_2 = require_htmlparser2();
  var parse5_1 = require_parse5();
  var domhandler_1 = require_lib3();
  function parse(content, options, isDocument) {
...
var require_boolbase = __commonJS((exports, module2) => {
  module2.exports = {
...
var require_static = __commonJS((exports) => {
  ...
  function html(dom, options) {
    ...
    return render(this || void 0, dom, options);
  }
  exports.html = html;
  function xml(dom) {
...
var require_attributes2 = __commonJS((exports) => {
  ...
  function prop(name, value) {
    ...
    if (typeof name === "object" || value !== void 0) {
      if (typeof value === "function") {
        ...
        return utils_1.domEach(this, function(j, el2) {
          if (utils_1.isTag(el2))
            setProp(el2, name, value.call(el2, j, getProp(el2, name)));
        });
      }
      return utils_1.domEach(this, function(__, el2) {
        if (!utils_1.isTag(el2))
          return;
        if (typeof name === "object") {
          Object.keys(name).forEach(function(key) {
            var val2 = name[key];
            setProp(el2, key, val2);
          });
        } else {
          setProp(el2, name, value);
        }
      });
    }
    return void 0;
  ...
  function addClass(value) {
    if (typeof value === "function") {
      return utils_1.domEach(this, function(i2, el2) {
        if (utils_1.isTag(el2)) {
...
var require_traversing = __commonJS((exports) => {
  ...
  function find(selectorOrHaystack) {
    ...
    var options = {context, xmlMode: this.options.xmlMode};
  ...
  function siblings(selector) {
    ...
    var elems = parent2.children().toArray().filter(function(elem) {
  ...
  function has(selectorOrHaystack) {
    var _this = this;
    return filter.call(this, typeof selectorOrHaystack === "string" ? ":has(" + selectorOrHaystack + ")" : function(_, el) {
  ...
  function traverseParents(self2, elem, selector, limit) {
    ...
    while (elem && elems.length < limit && elem.type !== "root") {
      if (!selector || filter.call([elem], selector, self2).length) {
        elems.push(elem);
      }
      elem = elem.parent;
    }
...
var require_manipulation2 = __commonJS((exports) => {
  ...
  function html(str) {
    ...
    return utils_1.domEach(this, function(_, el2) {
...
var require_cheerio = __commonJS((exports) => {
  "use strict";
  Object.defineProperty(exports, "__esModule", {value: true});
  ...
  var options_1 = tslib_1.__importStar(require_options());
  var utils_1 = require_utils();
  var Static = tslib_1.__importStar(require_static());
  ...
  var Cheerio = function() {
    function Cheerio2(selector, context, root, options) {
      ...
      if (!(this instanceof Cheerio2)) {
        return new Cheerio2(selector, context, root, options);
      }
      this.length = 0;
      ...
      if (root) {
        ...
        this._root = Cheerio2.call(this, root);
      }
      ...
      var search = selector;
      var searchContext = !context ? this._root : typeof context === "string" ? utils_1.isHtml(context) ? new Cheerio2(parse_1.default(context, this.options, false)) : (search = context + " " + search, this._root) : utils_1.isCheerio(context) ? context : new Cheerio2(context);
      if (!searchContext)
        return this;
      return searchContext.find(search);
    }
    Cheerio2.prototype._make = function(dom, context, root) {
      if (root === void 0) {
        root = this._root;
      }
      var cheerio2 = new this.constructor(dom, context, root, this.options);
    ...
    Cheerio2.html = Static.html;
    Cheerio2.xml = Static.xml;
    Cheerio2.text = Static.text;
    Cheerio2.parseHTML = Static.parseHTML;
    Cheerio2.root = Static.root;
    Cheerio2.contains = Static.contains;
    Cheerio2.merge = Static.merge;
    Cheerio2.fn = Cheerio2.prototype;
    return Cheerio2;
  }();
...
var require_load = __commonJS((exports) => {
  "use strict";
  Object.defineProperty(exports, "__esModule", {value: true});
  exports.load = void 0;
  var tslib_1 = require_tslib();
  ...
  function load2(content, options, isDocument) {
    ...
    var initialize = function(_super) {
      tslib_1.__extends(initialize2, _super);
      function initialize2(selector, context, r, opts) {
        if (r === void 0) {
          r = root;
        }
        var _this = this;
        if (!(_this instanceof initialize2)) {
          return new initialize2(selector, context, r, opts);
        }
        _this = _super.call(this, selector, context, r, tslib_1.__assign(tslib_1.__assign({}, options), opts)) || this;
        return _this;
      }
      initialize2.fn = initialize2.prototype;
      return initialize2;
    }(cheerio_1.Cheerio);
    initialize.prototype._originalRoot = root;
    Object.assign(initialize, staticMethods, {load: load2});
...
var require_lib14 = __commonJS((exports) => {
  ...
  var tslib_1 = require_tslib();
  var cheerio_1 = tslib_1.__importDefault(require_cheerio());
...
// functions/metafetcher.ts
__markAsModule(exports);
__export(exports, {
  handler: () => handler
});
var import_isomorphic_unfetch = __toModule(require_isomorphic_unfetch());
var cheerio = __toModule(require_lib14());
var handler = async (event, context) => {
  var _a, _b;
  if (event.httpMethod === "GET") {
    try {
      let result;
      if ((_a = event.queryStringParameters) == null ? void 0 : _a.url) {
        const res = await (0, import_isomorphic_unfetch.default)((_b = event.queryStringParameters) == null ? void 0 : _b.url);
...
//# sourceMappingURL=metafetcher.js.map
